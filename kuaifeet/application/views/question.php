			...
			<div class="container text-center align-content-md-center">
				...
				<div class="row">
					...
					<div class="col-md-4" style=" background: rgba(0,0,0,0.5);">
						<h1 class="font-weight-bold " style="font-family: 'Amatic SC', cursive; font-size:35px;">Please answer safe-question:</h1>
						<hr>
						<!-- question interface button -->
						<form method="POST" action="<?php echo base_url(); ?>Forgetpassword/getsafe_answer">
							...
							<br>
							<!-- question context -->
							<?php foreach ($safe_question as $item) : ?>
								<h4 class="font-weight-bolder " style="font-family: 'Amatic SC', cursive; font-size: 30px; color: #ffffff">QUESTION: <?= $item['safe_question'] ?></h4>
							<?php endforeach; ?>
							<div class="form-row">
								<div class="col-lg-1"></div>
								<div class="col-lg-10">
									<!-- input answer -->
									<input type="text" style="width: 100%;" class="form-control" name="answer" placeholder="answer" />
								</div>
								<div class="col-lg-1"></div>
							</div>
							<br>
