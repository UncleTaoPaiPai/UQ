...
<head>
	...
	<style type="text/css">
		...
		/* restart set register interface */
		#hero .content {
		...
		/* restart set register interface button */
		.btn1 {
			border: none;
			outline: none;
			height: 50px;
			...
			<div class="container text-center align-content-md-center">
				...
				<div class="row">
					...
					<div class="col-md-4" style=" background: rgba(0,0,0,0.5);">
						<h1 class="font-weight-bold " style="font-family: 'Amatic SC', cursive; font-size: 50px;">Restart set Password</h1>
						<hr>
						<!-- restart set register interface button -->
						<form method="POST" action="<?php echo base_url(); ?>Registration/resetpassword">
							...
							<br>
							<h4 class="font-weight-bolder " style="font-family: 'Amatic SC', cursive; font-size: 30px; color: #ffffff">Please type your new password:</h4>
							<div class="form-row">
								<div class="col-lg-1"></div>
								<div class="col-lg-10">
