			...
			<div class="container text-center align-content-md-center">
				...
				<div class="row">
					...
					<div class="col-md-4" style=" background: rgba(0,0,0,0.5);">
						<h1 class="font-weight-bold " style="font-family: 'Amatic SC', cursive; font-size: 50px;">Email:</h1>
						<hr />
						<h4 class="font-weight-bolder " style="font-family: 'Amatic SC', cursive; font-size: 30px; color: #ffffff">·Write down your Email:</h4>
						<!-- E-mail validation interface button -->
